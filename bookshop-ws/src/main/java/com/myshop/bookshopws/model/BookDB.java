		...
		public boolean createBook(Book book) {
			...
			try {
				...
				if (count > 0) {
					...
					String sql = "INSERT INTO javaassignment.book (isbn, title, author, price, quantity, publisher, publication_date, cat_id, image, sold_count) values(?, ?, ?, ?, ?, ?, ?, ?, ?,?)";
					...
					pstmt.setInt(10, book.getSold_count());
