...
public class GetAddressServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int userid=Integer.parseInt(request.getSession().getAttribute("sessUserID").toString());
	RequestDispatcher dispatcher = request.getRequestDispatcher("MainWebsite/MakePayment.jsp");
